...
from uciqe_uiqm import getUCIQE, getUIQM
...
img_name_list = glob(pred_imgs_dir + '/*.png')
img_name_list.extend(glob(pred_imgs_dir + '/*.jpg'))
img_name_list.sort()
...
for img_name in tqdm(img_name_list):
    ...
    img = to_tensor(Image.open(img_name)).unsqueeze(0)
    vals = []
